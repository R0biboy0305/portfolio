...
export default async function ProjectDetails({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="text-gray-900 dark:text-white flex flex-col gap-12 max-w-6xl mx-auto px-6 py-12 relative">
            ...
            <AnimatedSection>
                <div className="flex flex-col gap-3">
                    ...
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900/60 dark:from-white dark:via-white dark:to-white/30">
                        {project.title}
                    </h1>
